...
public class EV_CP_Engine {
    ...
    public void start() {
        ...
        log("[INFO] CP Engine started for CP-" + cpId);
    ...
    private void handleAuthorizationMessage(String message) {
        ...
        try {
            ...
            log("[ERROR] Error handling authorization: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void sendTelemetry(String message) {
        try {
            ...
            log("[ERROR] Error sending telemetry: " + e.getMessage());
        }
    }
    ...
    private void sendStatusUpdate(String status) {
        try {
            ...
            log("[ERROR] Error sending status: " + e.getMessage());
        }
    }
