...
public class DatabaseManager {
    ...
    public boolean insertChargingPoint(ChargingPoint cp) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("❌ Insert charging point failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean removeChargingPoint(String id) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("❌ Delete charging point failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public List<ChargingPoint> getAllChargingPoints() {
        ...
        try (Statement stmt = connection.createStatement();
            ...
            System.out.println("📋 Loaded " + points.size() + " charging points from database");
        } catch (SQLException e) {
            System.err.println("❌ Get all charging points failed: " + e.getMessage());
        }
    ...
    public boolean updateChargingPoint(ChargingPoint cp) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("❌ Update charging point failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public ChargingPoint getChargingPoint(String id) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("❌ Get charging point by ID failed: " + e.getMessage());
        }
    ...
    public boolean driverExists(String driverId) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("❌ Check driver exists failed: " + e.getMessage());
        }
