...
public class CentralUI extends JFrame {
    ...
    private void setupUI() {
        ...
        statusLabel = new JLabel("Central Server Initializing...");
        ...
        driverCountLabel = new JLabel("Total Drivers: 0");
        ...
        String[] columns = {"ID", "Location", "State", "Price (EUR/kWh)", "Power (kW)", "Vehicle", "Energy (kWh)", "Cost (EUR)"};
    ...
    public void appendLog(String message) {
        SwingUtilities.invokeLater(() -> {
            if (message.contains("CENTRAL SERVER started")) {
                statusLabel.setText("Central Server Running");
            }
    ...
    public void updateDriverCount(int count) {
        SwingUtilities.invokeLater(() -> driverCountLabel.setText("Total Drivers: " + count));
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ui.addOrUpdateCP("1", "Madrid Centro", "OFFLINE", 0.35, 0.0, null, 0.0, 0.0);
            ui.addOrUpdateCP("2", "Barcelona Port", "OFFLINE", 0.40, 0.0, null, 0.0, 0.0);
            ui.appendLog("Waiting for server connection...");
        });
    }
}